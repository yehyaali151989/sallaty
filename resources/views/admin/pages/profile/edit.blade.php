                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{ __('mine.Edit Profile') }}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('update.profile.admin') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="email">{{ __('mine.Email') }}</label>
                                                            <input type="text" value="{{$admin->email}}" id="email" class="@error('email') is-invalid @enderror form-control" name="email">
                                                            @error("email")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
