        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{ route('sub_categories.index') }}">{{ __('mine.Sub Categories') }}</a></li>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                  <form class="form" action="{{route('sub_categories.update',$category -> id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-body">
                      <h4 class="form-section">
                        <i class="ft-home"></i>
                        {{ __('mine.Sub Category Data') }}
                      </h4>

                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="projectinput2">{{ __('mine.Select Category') }}</label>
                            <select name="parent_id" class="select2 form-control">
                              <optgroup label="{{ __('mine.Select Category') }}">
