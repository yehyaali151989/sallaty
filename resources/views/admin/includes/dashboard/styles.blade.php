<link rel="apple-touch-icon" href="{{ asset('admin/app-assets/images/ico/sallaty-logo.png') }}">
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('admin/app-assets/images/ico/sallaty-logo.png') }}">
...
<link rel="stylesheet" type="text/css" href="{{asset('admin/app-assets/'.getFolder().'/plugins/animate/animate.css')}}">
...
<link rel="stylesheet" type="text/css" href="{{asset('admin/app-assets/'.getFolder().'/core/menu/menu-types/vertical-menu.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('admin/app-assets/'.getFolder().'/pages/chat-application.css')}}">
...
<link rel="stylesheet" type="text/css" href="{{asset('admin/app-assets/'.getFolder().'/core/colors/palette-gradient.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('admin/app-assets/'.getFolder().'/pages/timeline.css')}}">
